    ...
    payloads.update(
        {
            ...
            # SEC-1: natural jailbreaks that omit a temporal context word (observed bypasses).
...
def malicious_base64_corpus() -> list[str]:
    ...
    # SEC-2: short base64 destructive commands (encoded < 16 chars, within the decode floor).
