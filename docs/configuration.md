...
Apply an overlay with `helm install norviq oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.1 -n norviq -f values-prod.yaml`
...
```
helm install norviq oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.1 -n norviq --create-namespace \
...
helm install norviq oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.1 -n norviq \
