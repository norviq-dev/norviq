...
Apply an overlay with `helm install norviq oci://ghcr.io/norviq-dev/charts/norviq --version 0.1.5 -n norviq -f values-prod.yaml`
...
```
helm install norviq oci://ghcr.io/norviq-dev/charts/norviq --version 0.1.5 -n norviq --create-namespace \
