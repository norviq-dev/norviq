...
```bash
helm pull oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.4 --untar
...
the pull entirely and reference `oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.4` directly.
