...
```bash
helm pull oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.1 --untar
...
the pull entirely and reference `oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.1` directly.
