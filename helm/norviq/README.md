...
```bash
helm install norviq oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.1 \
...
```bash
helm pull oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.1 --untar   # for values-prod.yaml
...
```bash
helm upgrade norviq oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.1 -n norviq --reset-then-reuse-values
