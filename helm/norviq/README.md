...
```bash
helm pull oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.5 --untar   # for values-prod.yaml
...
```bash
helm upgrade norviq oci://ghcr.io/norviq-dev/charts/norviq --version 0.2.5 -n norviq --reset-then-reuse-values
