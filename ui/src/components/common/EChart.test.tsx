...
// UI-1 regression guard: the echarts-for-react CJS default import must resolve to a valid React
...
// (memo/forwardRef). The UI-1 bug was ReactEChartsCore resolving to the CJS namespace object
...
describe("UI-1: echarts interop is a valid React component", () => {
