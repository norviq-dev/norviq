...
# The engine also supplies a confusable-skeleton fold of the tool NAME (homoglyph/zero-width on
...
# Noun-first forms (valve_close, pump_start, switch_open, gate_close, …) added so the common
# SCADA naming convention BLOCKS like its verb-first twin. set_voltage / configure_protection.
energy_control_verbs = [
    ...
    # Noun-first control names (the bypass set)
    ...
    # Additional SCADA control verbs
...
# Device-noun ROOTS added (valve/pump/gate/switch/motor/generator/turbine/capacitor/regulator)
...
# Bare actuation verbs + device nouns for DECOMPOSED param phrasing:
...
# Decomposed param phrasing — a bare actuation verb in one field + a device noun in another
