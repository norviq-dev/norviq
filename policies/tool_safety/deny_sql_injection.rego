...
package norviq.tool_safety.deny_sql_injection
...
patterns := ["drop table", "union select", "or 1=1"]
...
rule_id := "deny_sql_injection" if detected
rule_id := "default_allow" if not detected

reason := "Policy deny_sql_injection triggered" if detected
